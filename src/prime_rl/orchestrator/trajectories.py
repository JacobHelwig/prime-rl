...
def interleave_rollout(
    ...
    preserved_prompt_messages_by_step: list[list[dict[str, Any]] | None] | None = None,
    ...
    def make_sample(tokens: dict[str, Any]) -> TrainingSample:
        ...
        return TrainingSample(
            ...
            teacher_completion_ids=None,
            routed_experts=routed_experts,
        )

    def set_teacher_context(sample: TrainingSample, step_idx: int) -> None:
        if preserved_prompt_messages_by_step is not None:
            sample.prompt_messages = preserved_prompt_messages_by_step[step_idx]
        sample.teacher_completion_ids = list(prepared_steps[step_idx]["completion_ids"])
